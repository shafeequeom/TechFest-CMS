            ...
            <div id="block">
               ...
               <div id="insideblock">
                ...
                <tbody>
                   ...
                   <tr>
                     <td> No. of Registrations - Online</td>
                     <td> <?php 
           $amntonline=mysql_fetch_array(mysql_query("SELECT count( regid ) FROM  `appuser_transactions` WHERE appuserid =  'online'"));
           echo $amntonline[0]; ?> </td>
                   </tr>
                   <tr>
                     <td>  Amount Collected - Online </td>
                     <td> <?php 
           $amntonline1=mysql_fetch_array(mysql_query("SELECT SUM( amount ) FROM  `appuser_transactions` WHERE appuserid =  'online'"));
           echo $amntonline1[0]; ?> </td>
                   </tr>
                    <tr>
