            ...
            <div id="block">
               ...
               <div id="insideblock">
                ...
                <form action="showlist.php?mode=0" method="post">
                        <button type="submit" class="btn btn-primary" style="float:left; width:18%; margin-top:20px; margin-left:10px;">Show All Registrations</button>
                </form>
                  <form action="showlist.php?mode=1" method="post">
                        <button type="submit" class="btn btn-primary" style="float:left; width:18%; margin-top:20px; margin-left:10px;">Show Paid Registrations</button>
                </form>
                  <form action="showlist.php?mode=2" method="post">
                        <button type="submit" class="btn btn-primary" style="float:left; width:18%; margin-top:20px; margin-left:10px;">Show UnPaid Registrations</button>
                </form>
                </div><br/><br/><br/><br/><br/>
                <div>
                     <h5>Custom Search</h5>
