...
$sql="INSERT INTO registration(id,name,usn,collegename,dept,contactno,eventname,regdate,email) VALUES('$id','$name','$usn','$college','$department','$contactno','$event','$regdate','$email')";
	mysql_query($sql);
               ...
               <div class="modal-header">  
                   ...
                   echo 'This has been registered under the USN '.$usn; 
					...
					echo "<h3>Enter Team Details</h3> <br>";
					   ...
					   if($college!="Toc H Institute of Science & Technology") {
