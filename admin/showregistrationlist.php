...
if(!isset($_GET['event'])) {
	...
	$query=mysql_query("SELECT * FROM registration  WHERE eventname='$event' AND paid=1");
	           $num=mysql_fetch_array(mysql_query("SELECT count( id ) FROM  `registration` WHERE eventname ='$event'"));
           $sum=mysql_fetch_array(mysql_query("SELECT SUM( amount ) FROM  `appuser_transactions` WHERE eventname='$event'"));
        ...
        <div class="container">
            ...
            <div id="block">
               ...
               <div id="insideblock">
                ...
                echo "<th>Total No Registration:</th>";
                              echo "<th> $num[0]</th>";

                echo "<th>Total Payment Recieved: </th>";
                              echo "<th>$sum[0]</th>";
