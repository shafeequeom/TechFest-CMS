...
$sql="UPDATE events SET name='$name',category='$category',timing='$date',groupSize='$size',feeHome='$feehome',feeRemote='$feehost',location='$location',discription='$discription',firstCashPrize='$first',secondCashPrize='$second' where name='$lname'";
...
echo'<h4><br> If no need of updating image </h4><a href="edit.php"  class="btn btn-warning" style="margin-left:200px;">Go Back</a>';
